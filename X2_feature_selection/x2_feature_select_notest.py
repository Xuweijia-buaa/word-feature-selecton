...
choose_top_K=20000 # not use temporarily
most_e_file='most_e_{}_notest.pkl'.format(choose_top_K)
...
with open('f_select_most_{}_20w_notest_top50'.format(choose_top_K),'w') as f:
    json.dump(r_words,f)